...
> **66 servers · 895 tools · one npm scope: [@theyahia](https://www.npmjs.com/org/theyahia)**
>
> Counts come from `node scripts/catalog.mjs`: every server is started over stdio and asked for `listTools()`. Last run — 2026-09-16.
...
![Servers](https://img.shields.io/badge/MCP_Servers-66-blue)
![Tools](https://img.shields.io/badge/Tools-895-green)
...
The catalog splits in two: **[Russia and CIS](#servers-for-russia-and-cis)** — 53 servers, 711 tools, the bulk of it; **[emerging markets](#servers-for-emerging-markets)** — 13 servers, 184 tools outside the post-Soviet space.
...
53 servers, 711 tools. Russia, Kazakhstan, Uzbekistan.
...
| Package | Version | Tools | What it does |
|---|---|---|---|
| [@theyahia/alfa-bank-mcp](https://www.npmjs.com/package/@theyahia/alfa-bank-mcp) | v1.1.0 | 8 tools | Alfa-Bank Business: accounts, statements, payment orders, counterparties, FX rates, payroll registries |
| [@theyahia/sber-mcp](https://www.npmjs.com/package/@theyahia/sber-mcp) | v1.2.0 | 8 tools | SberBusiness: accounts, balances, statements, payments, counterparties |
| [@theyahia/tochka-bank-mcp](https://www.npmjs.com/package/@theyahia/tochka-bank-mcp) | v2.0.0 | 7 tools | Tochka Bank: accounts, balances, statements, payments, customers |

#### ERP, accounting, CRM

| Package | Version | Tools | What it does |
|---|---|---|---|
| [@theyahia/kaiten-mcp](https://www.npmjs.com/package/@theyahia/kaiten-mcp) | v4.0.0 | 63 tools | Kanban: spaces, boards, cards, checklists, sprints |
...
| [@theyahia/kontur-diadoc-mcp](https://www.npmjs.com/package/@theyahia/kontur-diadoc-mcp) | v1.1.0 | 8 tools | EDI: documents, organizations, counterparties, sending and signing |
...
| [@theyahia/ati-su-mcp](https://www.npmjs.com/package/@theyahia/ati-su-mcp) | v2.0.0 | 12 tools | Freight exchange: loads, firms, trucks, dictionaries, distances |
...
| [@theyahia/superjob-mcp](https://www.npmjs.com/package/@theyahia/superjob-mcp) | v1.1.1 | 5 tools | Vacancy search, employers, towns, professions |

#### Marketing, analytics, web

| Package | Version | Tools | What it does |
|---|---|---|---|
| [@theyahia/tgstat-mcp](https://www.npmjs.com/package/@theyahia/tgstat-mcp) | v2.0.0 | 20 tools | Telegram channel analytics: search, stats, posts, mentions |
| [@theyahia/sendpulse-mcp](https://www.npmjs.com/package/@theyahia/sendpulse-mcp) | v1.1.1 | 11 tools | Email campaigns, mailing lists, templates, SMTP, web push |
...
| [@theyahia/vk-mcp](https://www.npmjs.com/package/@theyahia/vk-mcp) | v1.1.1 | 8 tools | VK: wall posts, post search, users, groups, messages |
...
| Package | Version | Tools | What it does |
|---|---|---|---|
| [@theyahia/voximplant-mcp](https://www.npmjs.com/package/@theyahia/voximplant-mcp) | v2.0.0 | 23 tools | Cloud telephony: calls, SMS, recordings, scenarios, ACD queues |
| [@theyahia/jivosite-mcp](https://www.npmjs.com/package/@theyahia/jivosite-mcp) | v1.1.1 | 11 tools | Live chat: chats, agents, contacts, messages, webhooks |
...
| [@theyahia/sms-ru-mcp](https://www.npmjs.com/package/@theyahia/sms-ru-mcp) | v1.1.1 | 5 tools | SMS sending, delivery status, cost, balance, senders |
...
| Package | Version | Tools | What it does |
|---|---|---|---|
| [@metarebalance/dadata-mcp](https://www.npmjs.com/package/@metarebalance/dadata-mcp) | v1.0.6 | 31 tools | Address, name and phone cleaning; company and bank lookup; geocoding |
...
13 servers, 184 tools outside the CIS. This half is younger and narrower than the CIS one; request a country through the [new server issue](https://github.com/theYahia/WWmcp/issues/new?template=new-server.yml).

| Package | Region | Version | Tools | What it does |
|---|---|---|---|---|
| [@theyahia/parasut-mcp](https://www.npmjs.com/package/@theyahia/parasut-mcp) | Turkey | v2.0.0 | 37 tools | Accounting: contacts, invoices, purchase bills, products, e-Fatura/e-Arşiv |
| [@theyahia/ifood-mcp](https://www.npmjs.com/package/@theyahia/ifood-mcp) | Brazil | v1.1.0 | 26 tools | Restaurant orders, merchant status and hours, catalog and prices |
| [@theyahia/paymongo-mcp](https://www.npmjs.com/package/@theyahia/paymongo-mcp) | Philippines | v1.1.0 | 24 tools | Payments, payment intents, checkout, links, customers, refunds, webhooks |
...
| [@theyahia/asaas-mcp](https://www.npmjs.com/package/@theyahia/asaas-mcp) | Brazil | v1.0.1 | 9 tools | Payments, Pix QR, customers, subscriptions, refunds |
...
| [@theyahia/kavenegar-mcp](https://www.npmjs.com/package/@theyahia/kavenegar-mcp) | Iran | v1.0.1 | 8 tools | SMS, bulk SMS, OTP, delivery status, account |
| [@theyahia/jazzcash-mcp](https://www.npmjs.com/package/@theyahia/jazzcash-mcp) | Pakistan | v2.0.1 | 5 tools | Wallet and mobile account payments, vouchers, status, refunds |

---

## Separate repositories

57 packages are published to npm under the same scope, but their code is **not in this monorepo** — each lives in its own repository. They cannot be built, tested or counted here, so check versions and tool counts on the npm package page.

The Source column links to the repository when it is public; "npm only" means there is no public repository.

<details>
<summary><b>57 packages outside the monorepo</b> (click to expand)</summary>
