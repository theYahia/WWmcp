 ...
 */
const BEHAVIOUR_ENV =
  /^(PORT|HOST|HTTP_PORT|HTTP_HOST|NODE_ENV|LOG_LEVEL|MCP_.*)$|_(SANDBOX|TEST|DEBUG|READONLY|WRITE_MODE|SERVICES|SCOPE|COUNTRY|USER_AGENT|TOKEN_FILE|ALLOW_RAW|RATE_LIMIT|MAX_CONCURRENCY|DNS_PROTECTION|ALLOWED_HOSTS|ALLOWED_ORIGINS|AUDIT_LOG|AUDIT_ACTOR|APPROVAL_TTL_SEC|TLS_CERT|TLS_KEY|TLS_CA)$|_(TIMEOUT|BACKOFF|DISABLE)/;
