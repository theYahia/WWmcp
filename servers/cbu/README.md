# MCP-сервер для ЦБ Узбекистана — 5 инструментов для ИИ-агента: курсы валют к суму и конвертация

Если вы искали, как дать Claude или другому ИИ-агенту официальные курсы Центрального банка Республики Узбекистан, — этот сервер отдаёт около 30 валют к суму (UZS) на сегодня или на историческую дату, направление дневного изменения и пересчёт сумм, в том числе кросс-курсом через сум. Спрашиваете «сколько это будет в сумах по курсу ЦБ на 1 марта» — получаете цифру и дату курса, по которому она посчитана. Ключей и регистрации не нужно: данные открытые, переменных окружения у сервера нет.
