...
export const tools: ToolDef[] = [
  ...
  },
  {
    ...
    description: "Search product variants (modifications). Returns name, code, sale price in rubles and meta href.",
    schema: searchVariantsSchema,
    handler: handleSearchVariants,
  },
  {
    name: "search_bundles",
    description: "Search bundles (kits/sets of products). Returns name, article, code, sale price in rubles and meta href.",
    schema: searchBundlesSchema,
    handler: handleSearchBundles,
  },
  {
    name: "search_services",
    description: "Search services (non-stock items sold or purchased). Returns name, code, sale price in rubles and meta href.",
    schema: searchServicesSchema,
    handler: handleSearchServices,
  },
  {
    name: "create_service",
    description: "Create a service (non-stock item). Sale price in RUBLES, attached to the account's default price type unless price_type_href is given.",
