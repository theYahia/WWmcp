# MCP-сервер для DaData — подсказки адресов, проверка компаний по ИНН и очистка данных через ИИ

Если вы искали, как подключить DaData к нейросети, пробить контрагента по ИНН, разобрать адрес на составные части или почистить базу телефонов и email — это оно. **31 инструмент вместо ~4 у [официального DaData MCP](https://dadata.ru/mcp/)**: адреса, компании, банки, телефоны, паспорта, автомобили, геокодирование и 12 справочников, из них 23 метода бесплатны. Ставится локально через `npx`, без внешнего хостинга — ключ остаётся у вас. Часть серии [WWmcp](https://github.com/theYahia/WWmcp) (46 серверов) by [@theYahia](https://github.com/theYahia).
...
| MCP | Статус | Описание |
|-----|--------|----------|
| [@metarebalance/dadata-mcp](https://github.com/theYahia/WWmcp/tree/main/servers/dadata) | ✅ готов | Адреса, компании, банки, телефоны |
...
| ... | 📅 | **46 серверов** — полный список на витрине |

**46 MCP-серверов для российских API:** [github.com/theYahia/WWmcp](https://github.com/theYahia/WWmcp)
